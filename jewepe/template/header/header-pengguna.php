...
<div class="navbar-collapse collapse justify-content-stretch" id="collapsibleNavbar">
	<ul class="navbar-nav">
		<li class="nav-item">
			<a class="nav-link text-secondary" href="../">Beranda</span></a>
		</li>
		<li class="nav-item">
			<a class="nav-link text-secondary" href="../kursus/">Materi Kursus</a>
		</li>
		<?php if (isset($_SESSION['role'])) { ?>
			<!-- Tambahan menu pada role admin dan peserta -->
			<li class="nav-item">
				<a class="nav-link text-secondary" href="../jadwal/">Jadwal Kursus</a>
			</li>
			<li class="nav-item">
				<a class="nav-link text-secondary" href="../pendaftaran/">Pendaftaran</a>
			</li>
		<?php }
		if ($_SESSION['role'] == 'admin') { ?>
			<!-- Tambahan menu pada role admin -->
			<li class="nav-item">
				<a class="nav-link text-secondary" href="../mahasiswa/">Mahasiswa</a>
			</li>
			<li class="nav-item">
				<a class="nav-link active text-secondary" href="#">Pengguna</a>
			</li>
		<?php } ?>
	</ul>
